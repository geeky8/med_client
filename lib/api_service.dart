...
const countryUrl = 'https://apitest.medrpha.com/api/register/getcountry';
const stateUrl = 'https://apitest.medrpha.com/api/register/getstate';
const stateUrlAll = 'https://apitest.medrpha.com/api/register/getstateall';
